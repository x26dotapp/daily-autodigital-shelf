...
- Latest verification: `verify-system.ps1` requires at least 21 pack manifests, 21 generated pack download ZIPs, the marketplace import kit, topic pages/topic JSON, 4 policy pages, support page, `llms.txt`, `llms-full.txt`, JSON/RSS/Atom feed paths, social metadata on generated public pages, the public support destination when support mode is connected, the GitHub fallback workflow, the daily task, and the watchdog task. It passed on 2026-06-02 after discovery commit `f90b8d9` with `files_checked: 33`, `bundle_bytes: 304869`, `pack_download_bytes: 126854`, `store_import_zip_bytes: 161610`, `monetization_enabled: true`, `support_connected: true`, and `store_connected: false`. Pages run `26805338049` deployed the support/discovery site; IndexNow accepted 29 changed URLs and a follow-up dry run showed 0 queued URLs. GitHub fallback run `26805392972` logged `No generated changes to publish`.
