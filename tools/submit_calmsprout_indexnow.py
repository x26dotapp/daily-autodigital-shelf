...
DYNAMIC_ROUTE_SOURCES: list[tuple[str, str]] = [
    ...
    ("/daily-shelf/download-metrics.json", "status.json"),
    ("/daily-shelf/daily-offer.json", "daily-offer.json"),
    ("/daily-shelf/support-signal.json", "support-signal.json"),
    ("/daily-shelf/checkout-readiness.json", "checkout-readiness.json"),
    ("/daily-shelf/revenue-proof.json", "revenue-proof.json"),
...
STATIC_ROUTE_SOURCES: list[tuple[str, str]] = [
    ...
    ("/daily-shelf/daily-offer", "daily-offer.html"),
    ("/daily-shelf/daily-offer/", "daily-offer.html"),
    ("/daily-shelf/daily-offer.html", "daily-offer.html"),
    ("/daily-shelf/support-signal.html", "support-signal.html"),
    ("/daily-shelf/checkout-readiness", "checkout-readiness.html"),
    ("/daily-shelf/checkout-readiness/", "checkout-readiness.html"),
    ("/daily-shelf/checkout-readiness.html", "checkout-readiness.html"),
    ("/daily-shelf/revenue-proof", "revenue-proof.html"),
    ("/daily-shelf/revenue-proof/", "revenue-proof.html"),
    ("/daily-shelf/revenue-proof.html", "revenue-proof.html"),
    ...
    ("/daily-shelf/support-signal", "support-signal.html"),
    ("/llms.txt", "llms.txt"),
    ...
    for item in catalog.get("items", []):
        if isinstance(item, dict):
            ...
            if slug:
                ...
                routes.append((f"/daily-shelf/packs/{slug}/printable.html", f"packs/{slug}/printable.html"))
                routes.append((f"/daily-shelf/packs/{slug}/checklist.html", f"packs/{slug}/checklist.html"))
