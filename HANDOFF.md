...
- Branded aliases: `https://www.calmsprout.com/daily-shelf/today`, `https://www.calmsprout.com/daily-shelf/bundle`, and `https://www.calmsprout.com/daily-shelf/status`
...
- Discovery: IndexNow key file live; latest direct `tools/submit_indexnow.py --all --wait-for-key-seconds 90` submitted 8 support-metadata URLs and received HTTP 200
...
- Latest functional infrastructure commit: `e50f94e` (`Add support monetization metadata`) pushed to `main`; GitHub Pages deployment `26808927786` succeeded
...
- Latest verifier baseline: `files_checked: 37`, `bundle_bytes: 328177`, `pack_download_bytes: 126887`, `store_import_zip_bytes: 162402`, `support_connected: true`, `store_connected: false`
