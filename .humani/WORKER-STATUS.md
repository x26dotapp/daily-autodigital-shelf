...
- State: idle
- Last updated: `2026-06-02T07:52:06-04:00`
...
- Discovery: IndexNow accepted 1 CalmSprout URL (`/daily-shelf/support-metrics.json`) with HTTP 200 after adding support-intent metrics; follow-up dry runs returned `submit_count: 0` for both hosts
